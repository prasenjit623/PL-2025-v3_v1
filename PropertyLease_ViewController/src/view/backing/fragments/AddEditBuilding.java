...
public class AddEditBuilding {
    ...
    public void onValidCreateRsMrkup(ValueChangeEvent valueChangeEvent) {
        valueChangeEvent.getComponent().processUpdates(FacesContext.getCurrentInstance());
        ...
        ViewObject buildVo = ADFUtils.findIterator("PropertyBuildings_VO1Iterator").getViewObject();
        Row buildCurrRow = buildVo.getCurrentRow();
        ViewCriteria vC = unitDtlRoVo.createViewCriteria();
        ViewCriteriaRow vCRow = vC.createViewCriteriaRow();
        vCRow.setAttribute("BuildId", buildCurrRow.getAttribute("BuildId"));
