  ...
  public RichSpacer getS2() {
    ...
    public void exportToExcel(FacesContext facesContext,
        ...
        try {
            ...
            rowhead.createCell(14).setCellValue("Business Unit");
            sheet.setColumnWidth(14, 6500);
            rowhead.createCell(15).setCellValue("Investment/Landlord");
            sheet.setColumnWidth(15, 4500);
            rowhead.createCell(16).setCellValue("Payment To");
            sheet.setColumnWidth(16, 4500);
            rowhead.createCell(17).setCellValue("Lease PM Fee(%)");
            sheet.setColumnWidth(17, 4000);
            rowhead.createCell(18).setCellValue("Landlord-Customer Tag WO");
            sheet.setColumnWidth(18, 5000);
            rowhead.createCell(19).setCellValue("Create Resource Markup");
            ...
            if (actVO.getEstimatedRowCount() > 0) {
                ...
                while (rs.hasNext()) {
                    ...
                    String areaValue =
                        ...
                        "";
                    String orgName =
                        actRow.getAttribute("OrgName") != null ? actRow.getAttribute("OrgName").toString() :
                        "";
                    String invstLandlrd =
                    ...
                    String payTo =
                        ...
                        "";
                    String pmFee =
                        actRow.getAttribute("PmFeeLease") != null ? actRow.getAttribute("PmFeeLease").toString() :
                        "";
                    String landlordCustTagWo =
                        actRow.getAttribute("LandlordCustTagWo") != null ? actRow.getAttribute("LandlordCustTagWo").toString() :
                        "";
                    String createResMrkup =
                        actRow.getAttribute("CreateResourceMarkup") != null ? actRow.getAttribute("CreateResourceMarkup").toString() :
                        "";
                    ...
                    row.createCell(14).setCellValue(orgName);
                    row.createCell(15).setCellValue(invstLandlrd);
                    row.createCell(16).setCellValue(payTo);
                    row.createCell(17).setCellValue(pmFee);
                    row.createCell(18).setCellValue(landlordCustTagWo);
                    row.createCell(19).setCellValue(createResMrkup);
                    excelRowData++;
                }
            }
