...
//    }
    ...
    public void exportToExcel(FacesContext facesContext,
        ...
        try {
                                        ...
                                        rowhead.createCell(1).setCellValue("LA No");
                                        ...
                                        if (actVO.getEstimatedRowCount() > 0) {
                                            ...
                                            while (rs.hasNext()) {
                                                ...
                                                String createDt =
                                                    ...
                                                    "";
                                                String invstOrLandlord =
                                                    actRow.getAttribute("TnxTypeLandlord") != null ?
                                                    actRow.getAttribute("TnxTypeLandlord").toString() :
                                                    "";
                                                String paymentTo =
                                                    actRow.getAttribute("CashInvolved") != null ?
                                                    actRow.getAttribute("CashInvolved").toString() :
                                                    "";
                                                ...
                                                row.createCell(15).setCellValue(invstOrLandlord);
                                                row.createCell(16).setCellValue(paymentTo);
