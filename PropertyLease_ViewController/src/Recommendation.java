...
//                                                      org, prop, unit, null, null);
    ...
    String emailId = "prasenjit.d@4iapps.com";
...
//    }
    ...
    public void onClickApprove(ActionEvent actionEvent) {
        ...
        Row row = vo.getCurrentRow();
//        String sts = row.getAttribute("Status")==null ? "" : row.getAttribute("Status").toString();
        String bkId_1 = row.getAttribute("BookingId")==null ? "" : row.getAttribute("BookingId").toString();
        String orgId_1 = row.getAttribute("OrgId")==null ? "" : row.getAttribute("OrgId").toString();
...
//                System.out.println("Status %%3%"+sts);
                String bkId_2 = row.getAttribute("BookingId")==null ? "" : row.getAttribute("BookingId").toString();
                if (bkId_2.equals("")){
                    row.setAttribute("BookingId", bkId_1);
                    row.setAttribute("OrgId", orgId_1);
                }
                ADFUtils.findOperation("Commit").execute();
                JSFUtils.addFacesInformationMessage("Approved Successfully");
            } else {
