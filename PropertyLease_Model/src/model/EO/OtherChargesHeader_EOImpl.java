...
public class OtherChargesHeader_EOImpl extends EntityImpl {
    ...
    /**
     * Gets the attribute value for TnxTypeLandlord, using the alias name TnxTypeLandlord.
    ...
    /**
     * Sets <code>value</code> as the attribute value for TnxTypeLandlord.
    ...
    /**
     * Gets the attribute value for CashInvolved, using the alias name CashInvolved.
    ...
    /**
     * Sets <code>value</code> as the attribute value for CashInvolved.
    ...
    /**
     * Gets the attribute value for LandlordName, using the alias name LandlordName.
    ...
    /**
     * Sets <code>value</code> as the attribute value for LandlordName.
     * @param value value to set the LandlordName
     */
    ...
    /**
     * Gets the attribute value for LandlordCustId, using the alias name LandlordCustId.
     * @return the LandlordCustId
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for LandlordCustId.
     * @param value value to set the LandlordCustId
     */
    ...
    /**
     * Gets the attribute value for LandlordCustName, using the alias name LandlordCustName.
     * @return the LandlordCustName
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for LandlordCustName.
     * @param value value to set the LandlordCustName
     */
    ...
    /**
     * Gets the attribute value for LandlordCustNo, using the alias name LandlordCustNo.
     * @return the LandlordCustNo
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for LandlordCustNo.
     * @param value value to set the LandlordCustNo
     */
    ...
    /**
     * Gets the attribute value for LandlordCustBillToSite, using the alias name LandlordCustBillToSite.
     * @return the LandlordCustBillToSite
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for LandlordCustBillToSite.
     * @param value value to set the LandlordCustBillToSite
     */
    ...
    /**
     * Gets the attribute value for ReceiptCreation, using the alias name ReceiptCreation.
     * @return the ReceiptCreation
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for ReceiptCreation.
     * @param value value to set the ReceiptCreation
     */
