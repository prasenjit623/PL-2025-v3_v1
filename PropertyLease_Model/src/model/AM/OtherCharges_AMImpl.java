...
//            ADFContext.getCurrent().getPageFlowScope().get("OfferId").toString();
    ...
    //submit for approval of OC oc flag N & C
        public String submitOcForAppr(String ocId, String userName)
        {
            String flag="null";
    ...
    //submit for approval of OC oc flag DP
        public String submitOcForApprDP(String ocId, String userName)
        {
            String flag="null";
    ...
    /**
     * Container's getter for OcPropDtl_RoVo1.
     * @return OcPropDtl_RoVo1
     */
    public ViewObjectImpl getOcPropDtl_RoVo1() {
        return (ViewObjectImpl)findViewObject("OcPropDtl_RoVo1");
    }

    /**
     * Container's getter for OcHdrDpVo_OcPropDtlRoVo1.
     * @return OcHdrDpVo_OcPropDtlRoVo1
     */
    public ViewLinkImpl getOcHdrDpVo_OcPropDtlRoVo1() {
        return (ViewLinkImpl)findViewLink("OcHdrDpVo_OcPropDtlRoVo1");
    }
}
