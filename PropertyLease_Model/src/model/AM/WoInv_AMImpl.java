...
public class WoInv_AMImpl extends ApplicationModuleImpl implements WoInv_AM {
    ...
    //bulk sync invoice from db
    public String callBulkSyncInv(String p_woInvHdrId,String p_userName)
    {
        String flag="null";
//        System.out.println("woInvHdrId :"+p_woInvHdrId);
        CallableStatement cs=this.getDBTransaction().createCallableStatement("{call WO_INV_PKG.BULK_SYNC_INV_WO(?,?,?,?)}",1);
        try {
            cs.setString(1,p_woInvHdrId);
            cs.setString(2,p_userName);
            cs.registerOutParameter(3,Types.VARCHAR);
            cs.registerOutParameter(4,Types.VARCHAR);
            cs.execute();
    ...
    /**
     * Container's getter for POInvRcpt_RoVo1.
     * @return POInvRcpt_RoVo1
     */
    public ViewObjectImpl getPOInvRcpt_RoVo1() {
        return (ViewObjectImpl)findViewObject("POInvRcpt_RoVo1");
    }

    /**
     * Container's getter for PoInvHdr_PoInvRcpt_VL1.
     * @return PoInvHdr_PoInvRcpt_VL1
     */
    public ViewLinkImpl getPoInvHdr_PoInvRcpt_VL1() {
        return (ViewLinkImpl)findViewLink("PoInvHdr_PoInvRcpt_VL1");
    }

    /**
     * Container's getter for GetWoInvDtlAr_RoVo1.
     * @return GetWoInvDtlAr_RoVo1
     */
    public ViewObjectImpl getGetWoInvDtlAr_RoVo1() {
        return (ViewObjectImpl)findViewObject("GetWoInvDtlAr_RoVo1");
    }

    /**
     * Container's getter for SearchWoInv_RoVo2.
     * @return SearchWoInv_RoVo2
     */
    public ViewObjectImpl getSearchWoInv_RoVo2() {
        return (ViewObjectImpl)findViewObject("SearchWoInv_RoVo2");
    }
}
