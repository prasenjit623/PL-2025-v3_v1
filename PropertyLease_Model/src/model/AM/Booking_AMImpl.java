...
public class Booking_AMImpl extends ApplicationModuleImpl implements Booking_AM {
    ...
    //Change tnx data like Payment To
            public String changeTnxData(String refId,String userId,String funcId,String changeData,String reason)
            {
                String flag="null";
                CallableStatement cs=this.getDBTransaction().createCallableStatement("{call XXFND_UTIL_PKG.CHANGE_TNX_DATA(?,?,?,?,?,?,?)}",1);
                try {
                    cs.setString(1,refId);
                    cs.setString(2,userId);
                    cs.setString(3,funcId);
                    cs.setString(4,changeData);
