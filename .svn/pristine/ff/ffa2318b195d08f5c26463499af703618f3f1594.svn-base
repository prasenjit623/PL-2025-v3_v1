...
// ---    Sun Jul 01 20:42:09 IST 2018
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class OwnerDtle_VORowImpl extends ViewRowImpl {
    /**
     * AttributesEnum: generated enum for identifying attributes and accessors. DO NOT MODIFY.
     */
    public enum AttributesEnum {
        Attribute1 {
            public Object get(OwnerDtle_VORowImpl obj) {
                return obj.getAttribute1();
            }

            public void put(OwnerDtle_VORowImpl obj, Object value) {
        ...
        OwnerId {
            ...
            public void put(OwnerDtle_VORowImpl obj, Object value) {
                obj.setOwnerId((BigDecimal)value);
            }
        },
        PrimaryYn {
            public Object get(OwnerDtle_VORowImpl obj) {
        ...
        VendId {
            ...
            public void put(OwnerDtle_VORowImpl obj, Object value) {
                obj.setVendId((BigDecimal)value);
            }
        },
        VendSiteId {
            public Object get(OwnerDtle_VORowImpl obj) {
        ...
        SearchProperty_ROVO1 {
            public Object get(OwnerDtle_VORowImpl obj) {
                return obj.getSearchProperty_ROVO1();
            }
        ...
        PropertyUnits_VO1 {
            public Object get(OwnerDtle_VORowImpl obj) {
                return obj.getPropertyUnits_VO1();
            }
        ...
        public abstract Object get(OwnerDtle_VORowImpl object);

        public abstract void put(OwnerDtle_VORowImpl object, Object value);
    ...
    public static final int VENDORROVO1 = AttributesEnum.VendorROVO1.index();
    public static final int VENDORSITEROVO1 =
        AttributesEnum.VendorSiteROVO1.index();
    public static final int SEARCHPROPERTY_ROVO1 =
        AttributesEnum.SearchProperty_ROVO1.index();
    public static final int BUILDINGS_ROVO1 =
        AttributesEnum.Buildings_ROVO1.index();
    public static final int PROPERTYUNITS_VO1 =
        AttributesEnum.PropertyUnits_VO1.index();

    /**
     * This is the default constructor (do not remove).
     */
    public OwnerDtle_VORowImpl() {
    }

    /**
     * Gets OwnerDtle_EO entity object.
     * @return the OwnerDtle_EO
     */
    public EntityImpl getOwnerDtle_EO() {
    ...
    public BigDecimal getOwnerId() {
        return (BigDecimal)getAttributeInternal(OWNERID);
    }
     ...
     */
    public void setOwnerId(BigDecimal value) {
     ...
     * @return the VEND_ID
     */
    public BigDecimal getVendId() {
        return (BigDecimal)getAttributeInternal(VENDID);
    }
     ...
     */
    public void setVendId(BigDecimal value) {
    ...
    public Boolean getisActive() {
        Boolean flag = false;
        if (this.getPrimaryYn() != null && this.getPrimaryYn().equals("Y")) {
            flag = true;
        } else {
            flag = false;
        }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> VendorROVO1.
     */
    public RowSet getVendorROVO1() {
        return (RowSet)getAttributeInternal(VENDORROVO1);
    }

    /**
     * Gets the view accessor <code>RowSet</code> VendorSiteROVO1.
     */
    public RowSet getVendorSiteROVO1() {
        return (RowSet)getAttributeInternal(VENDORSITEROVO1);
    }

    /**
     * Gets the view accessor <code>RowSet</code> SearchProperty_ROVO1.
     */
    public RowSet getSearchProperty_ROVO1() {
        return (RowSet)getAttributeInternal(SEARCHPROPERTY_ROVO1);
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> PropertyUnits_VO1.
     */
    public RowSet getPropertyUnits_VO1() {
        return (RowSet)getAttributeInternal(PROPERTYUNITS_VO1);
    }
